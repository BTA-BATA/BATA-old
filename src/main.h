...
static const CAmount DUST_THRESHOLD = 10000; // 0.0001 BTA
/** Bata: Default TX Fee per 1000 bytes */
static const CAmount DEFAULT_TX_FEE = 10000; // 0.0001 BTA

/** Bata: default minimum input threshold, override with -mininput */
static const CAmount DEFAULT_MINIMUM_INPUT_THRESHOLD = DUST_THRESHOLD / 100; // 0.000001 BTA
