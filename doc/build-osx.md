...
====================================
This guide will show you how to build batad(headless client) for OS X.
...
After exiting, you'll get a warning that the install is keg-only, which means it wasn't symlinked to `/usr/local`.  You don't need it to link it to build bata, but if you want to, here's how:
...
1. Clone the GitHub tree to get the source code and go into the directory.
        ...
        git clone https://github.com/bata-project/bata.git
        cd bata
...
4.  (Optional) You can also install batad to your path:
