...
### Download the Blockchain from the BataNode Project

The Bata node project provides multiple and regulaly updated direct-link downloads. Copies of bootstrap.dat can be downloaded directly from servers provided by BataNode, or be downloaded from a randomly selected server. All copies of boootstrap are updated at the maximum of every six months.

**Copies of Bootstrap from a specific server**

* [http://mango.batanode.org/bootstrap.dat](http://mango.batanode.org/bootstrap.dat)
* [http://apple.batanode.org/bootstrap.dat](http://apple.batanode.org/bootstrap.dat)

**Randomly selected dopy of Bootstrap**

This could be useful for use in scripts.

* [http://bootstrap.batanode.org/bootstrap.dat](http://bootstrap.batanode.org/bootstrap.dat)
	
**Example usage in a (bash) Terminal**

	wget http://bootstrap.batanode.org/bootstrap.dat       //downloads bootstrap into current directory
